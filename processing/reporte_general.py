def generate_morphometric_report_general(dicom_dir, subjects_dir, base_control_path):
    ...
    def create_page_content(page_number):
        ...
        if page_number == 0:
            ...
            can.drawString(193, 688, "Volúmenes [cm³] y espesores [mm] globales")
            ...
            can.drawString(355, 143, "Sustancia blanca")
            can.drawString(495, 143, "Sustancia gris")
            ...
            dibujar_imagen_escalada(can, ruta_imagen_1, 70, 418, factor_escala=0.23)
        ...
        # Asumiendo que tienes las columnas con anchos definidos. Se definen anchos fijos para cada columna.
            ...
            can.drawString(205, 310, "Reconstrucción de Lóbulos corticales")
            # Rutas de las imágenes
