# Morofometria Cerebral con FastSurfer
 ...
 **Selección y análisis de modelos** (`seleccion_modelos/`)  
   ...
   - Cálculo de métricas de concordancia ( **Dice**, **HD95**).
...
1. **Entrada**  
   ...
   - Metadatos clínicos y de adquisición.
...
4. **Recursos auxiliares** (`recursos/`)  
   - Imágenes, plantillas y otros recursos que sirven de apoyo para informes.

5. **Automatización y utilidades**  
   - `morfo_email.sh`: orquestador general, lanza el contenedor y ejecuta el pipeline completo.
