...
#SBATCH --output=/home/mbudani/results/synthseg_array_results/synthseg_%A_%a.out
#SBATCH --error=/home/mbudani/results/synthseg_array_results/synthseg_%A_%a.err
...
OUTPUT_DIR="/home/mbudani/results/synthseg_array_results"  # Carpeta de salida general
